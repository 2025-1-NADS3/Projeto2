...
public class LivrariaActivity extends br.com.example.fecapayplus.ui.activities.NavigationMenu
        implements ProdutoAdapter.OnProdutoClickListener{

    public String loja = "livraria";
    @Override
            ...
            public void onResponse(Call<ProdutoDTO> call, Response<ProdutoDTO> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (produtos.isEmpty()) {
                        ...
                        recyclerView.setAdapter(new ProdutoAdapter(produtos, (ProdutoAdapter.OnProdutoClickListener) LivrariaActivity.this));
                    }
                }else {
