...
public class PapelariaActivity extends br.com.example.fecapayplus.ui.activities.NavigationMenu
        implements ProdutoAdapter.OnProdutoClickListener{

    public String loja = "papelaria";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repo.getProdutos(loja, new Callback<ProdutoDTO>() {
            ...
            public void onResponse(Call<ProdutoDTO> call, Response<ProdutoDTO> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (produtos.isEmpty()) {
                        ...
                        recyclerView.setAdapter(new ProdutoAdapter(produtos, (ProdutoAdapter.OnProdutoClickListener) PapelariaActivity.this));
                    }
                }else {
            ...
            public void onFailure(Call<ProdutoDTO> call, Throwable t) {
                ...
                textSemItens.setVisibility(View.VISIBLE);
                recyclerView.setVisibility(View.GONE);
                Log.e("Erro", "Erro interno: " + t.getMessage());
            }
        });
