...
public class CantinaActivity extends br.com.example.fecapayplus.ui.activities.NavigationMenu
        implements ProdutoAdapter.OnProdutoClickListener {

    public String loja = "cardapio";
            ...
            public void onResponse(Call<ProdutoDTO> call, Response<ProdutoDTO> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (produtos.isEmpty()) {
                        ...
                        recyclerView.setAdapter(new ProdutoAdapter(produtos, (ProdutoAdapter.OnProdutoClickListener) CantinaActivity.this));
                    }
                }else {
